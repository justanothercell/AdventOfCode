...
def display(p, first=False):
    ...
    for my in range(0, h):
        for mx in range(w):
             c = map[my][mx]
             if (mx, my) == (x, y):
                assert c == 0, 'robot sits on something'
                print('\x1b[38;2;255;255;255m@\x1b[0m', end='')
             elif c == -1:
                print('\x1b[38;2;255;0;0m#\x1b[0m', end='')
             elif c == 0:
                print('\x1b[38;2;100;100;100m.\x1b[0m', end='')
             else:
                r, g, b = colors[c]
                if mx > 0 and map[my][mx-1] == c:
