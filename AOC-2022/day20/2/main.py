...
# x, y, z:  811589153 2434767459 -1623178306
...
mix_list = [(index, int(i.strip()) * 811589153) for index, i in enumerate(mix_list)]
    ...
    for i in range(len(mix_list)):
        for j in range(len(mix_list)):
            if mix_list[j][0] == i:
                ...
                mix_list.insert((j + e + len(mix_list)) % len(mix_list), (index, e))
                break
...
# x, y, z:  4670695575515 2769142190036 328693606965
# coordinate: 7768531372516
